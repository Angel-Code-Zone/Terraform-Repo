# This is the main resources file.
...
resource "github_repository" "Python_Repository" {
  name        = "Python-Repo"
  description = "Learning python scripting for daily automation and manual tasks"
  visibility  = "public"
  auto_init   = false
}
